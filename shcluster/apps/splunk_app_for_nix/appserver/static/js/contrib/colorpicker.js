...
(function(window, document, undefined, _, $) {
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        var idColorGradient, idBlackGradient, idWhiteGradient;

        /**
         * Create slide and picker markup depending on the supported technology.
         */
        if (type == 'SVG') {
            idColorGradient = _.uniqueId('gradient-hsv-');
            idBlackGradient = _.uniqueId('gradient-black-');
            idWhiteGradient = _.uniqueId('gradient-white-');
            slide = $('svg', { xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '100%', height: '100%' },
                      [
                          $('defs', {},
                            $('linearGradient', { id:idColorGradient , x1: '0%', y1: '100%', x2: '0%', y2: '0%'},
                              [
                          ...
                          $('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'url(#'+idColorGradient+')'})
                      ]
                     );
            ...
            picker = $('svg', { xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '100%', height: '100%' },
                       [
                           $('defs', {},
                             [
                                 $('linearGradient', { id: idBlackGradient, x1: '0%', y1: '100%', x2: '0%', y2: '0%'},
                                   [
                                       $('stop', { offset: '0%', 'stop-color': '#000000', 'stop-opacity': '1' }),
                                       $('stop', { offset: '100%', 'stop-color': '#CC9A81', 'stop-opacity': '0' })
                                   ]
                                  ),
                                 $('linearGradient', { id: idWhiteGradient, x1: '0%', y1: '100%', x2: '100%', y2: '100%'},
                                   [
                           ...
                           $('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'url(#' + idWhiteGradient + ')'}),
                           $('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'url(#' + idWhiteGradient + ')'})
                       ]
                      );
        ...
        if (type == 'SVG') {
            ...
            var hsvGradient = slide.getElementById(idColorGradient);
            ...
            var blackAndWhiteGradients = [picker.getElementById(idBlackGradient), picker.getElementById(idWhiteGradient)];
...
})(window, window.document, undefined, UnixUnderscore, UnixjQuery);
